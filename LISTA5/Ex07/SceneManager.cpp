...
void SceneManager::setupScene()
{
	...
	obj->setDimension(glm::vec3(800.0f, 800.0f, 1.0f)); //note que depois podemos reescalar conforme tamanho da sprite
	obj->setShader(shaders[6]);//Ex07
...
void SceneManager::setupCamera2D() //TO DO: parametrizar aqui
{
	...
	float ratio = 1.0;
	float xMin = 0.0, xMax = 800.0, yMin = 0.0, yMax = 800.0, zNear = -1.0, zFar = 1.0;
