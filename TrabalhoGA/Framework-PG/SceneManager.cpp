...
void SceneManager::update()
{
	...
	if ((camadas[personagem].objects[0]->getPosX()+31 >= camadas[coin].objects[0]->getPosX() - 32.5f) && (camadas[personagem].objects[0]->getPosX() < camadas[coin].objects[0]->getPosX()))
	{
		camadas[coin].objects[0]->setPosX(1200.0f);

	}
	else if ((camadas[personagem].objects[0]->getPosX()-31 <= camadas[coin].objects[0]->getPosX() + 32.5f )&&(camadas[personagem].objects[0]->getPosX()> camadas[coin].objects[0]->getPosX()))
	{
		camadas[coin].objects[0]->setPosX(1200.0f);
	}
}
...
void SceneManager::setupScene()
{
	...
	for (int i = 0; i < 3; i++)
	{
		camadas[i].adcionarObjeto(402.0f, 340.0f, 0.0, 800.0f, 550.0f, 0.0f, shader);
		camadas[i].adcionarObjeto(1200.0f, 340.0f, 0.0, 800.0f, 550.0f, 0.0f, shader);

	}
	camadas[0].setDesloc(-35.0f);
	camadas[1].setDesloc(-50.0f);
	camadas[2].setDesloc(-65.0f);


	camadas[chao].adcionarObjeto(400.0f, 36.0f, 0.0, 800.0f, 80.0f, 1.0f, shader);
	camadas[chao].adcionarObjeto(1200.0f, 36.0f, 0.0, 800.0f, 80.0f, 1.0f, shader);
	camadas[chao].setDesloc(-125.0f);

	camadas[personagem].adcionarObjeto(50.0f, 113.0f, 0.0f, 60.0f, 120.0f, 1.0f, shader);
	camadas[personagem].setDesloc(0.2f);

	//fixo
	camadas[coin].adcionarObjeto(500.0f, 113.0f, 0.0f, 33.0f, 33.25f, 1.0f, shader);
	...
	camadas[coin].objects[0]->setTexture(texID);
